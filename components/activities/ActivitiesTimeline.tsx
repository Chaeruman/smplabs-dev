  ...
  const allActivities = [
    {
      ...
      title: "SAKSI",
      description:
        "tudi dan Apresiasi Kepemimpinan Siswa Indonesia, sebuah program yang diadakan oleh SMP Labschool Jakarta. Program ini bertujuan untuk membentuk karakter kepemimpinan siswa melalui berbagai kegiatan seperti studi lapangan, pelatihan, dan apresiasi. SAKSI juga menjadi wadah bagi siswa untuk mengembangkan keterampilan, kemandirian, dan kedisiplinan.",
      date: "",
      time: "",
