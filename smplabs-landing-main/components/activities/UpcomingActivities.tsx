      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {upcomingActivities.map((activity, index) => (
            <div
              key={activity.id}
              className={`${getCardColor(index)} ${getPriorityColor(activity.priority)} rounded-2xl p-6 shadow-lg hover-glow transition-all duration-1000 ${
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <span
                  className={`text-xs px-2 py-1 rounded-full ${
                    activity.priority === "high" ? "bg-red-100 text-red-600" : "bg-yellow-100 text-yellow-600"
                  }`}
                >
              ...
              {/* Action Button */}
              <button className="w-full bg-gradient-to-r from-blue-500 to-purple-500 text-white py-3 px-4 rounded-lg font-semibold transition-all duration-300 hover:from-blue-600 hover:to-purple-600 hover:shadow-lg group">
                Daftar Sekarang
